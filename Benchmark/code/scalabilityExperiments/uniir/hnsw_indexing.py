#!/usr/bin/env python3
"""
Build FAISS HNSW index from UniIR image embeddings
(STREAMING, RAM-safe)
"""
...
INDEX_PATH = os.path.join(OUT_DIR, "uniir_image_hnsw.index")
...
def main():
    ...
    for fname in tqdm(files, desc="Indexing UniIR embeddings (HNSW)"):
    ...
    print("=" * 60)
    print("[DONE] UniIR HNSW index built successfully")
