#!/usr/bin/env python3
"""
UniIR (OpenCLIP) Text → Image Retrieval Evaluation (LAION)

- Uses UniIR image FAISS index
- Encodes captions with OpenCLIP text encoder
- Computes Recall@K
- Prints debug results
"""
...
INDEX_PATH = os.path.join(BASE_DIR, "index/uniir_image.index")
...
print("[INFO] Loading UniIR (OpenCLIP) model...")
...
print("\n[DONE] UniIR retrieval test complete.")
