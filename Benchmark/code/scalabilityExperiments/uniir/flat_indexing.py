#!/usr/bin/env python3
"""
Build FAISS Flat (IP / cosine) index from UniIR image embeddings
(STREAMING, RAM-safe)
"""
...
INDEX_PATH = os.path.join(OUT_DIR, "uniir_image.index")
...
def main():
    ...
    for fname in tqdm(files, desc="Indexing UniIR embeddings"):
        ...
        if index is None:
            ...
            print(f"[INFO] FAISS Flat index initialized (dim={dim})")
    ...
    print("[INFO] Saving FAISS Flat index...")
    ...
    print("=" * 60)
    print("[DONE] UniIR Flat index built successfully")
