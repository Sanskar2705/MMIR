#!/usr/bin/env python3
"""
Build FAISS Flat index from CLIP image embeddings (STREAMING, RAM-safe)
"""
...
INDEX_PATH = os.path.join(OUT_DIR, "clip_image_flat.index")
...
def main():
    ...
    for fname in tqdm(files, desc="Indexing (Flat)"):
        ...
        if index is None:
            ...
            print(f"[INFO] IndexFlatIP initialized (dim={dim})")
    ...
    print("[DONE] CLIP Flat index built")
